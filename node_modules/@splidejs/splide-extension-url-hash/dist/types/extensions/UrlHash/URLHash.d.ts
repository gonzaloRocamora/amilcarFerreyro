 ...
 */
export declare function URLHash(Splide: Splide, Components: Components, options: Options): BaseComponent;
//# sourceMappingURL=../../../../src/js/extensions/URLHash/URLHash.d.ts.map